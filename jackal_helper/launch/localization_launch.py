...
def generate_launch_description():
    ...
    params_file_ekf = LaunchConfiguration('params_file_ekf')
    ...
    configured_params_ekf = ParameterFile(
        RewrittenYaml(
            source_file=params_file_ekf,
            root_key=namespace,
            param_rewrites={},
            convert_types=True,
        ),
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(local_bringup_dir, 'params', 'nav2_params.yaml'),
    ...
    ld.add_action(declare_params_file_cmd_ekf)
